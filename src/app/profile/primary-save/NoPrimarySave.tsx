export default function NoPrimarySave() {
  return (
    <div className="flex flex-col items-center justify-center w-full h-fit min-h-64 max-w-2xl mx-auto bg-[var(--color-darker)] rounded-xl shadow-lg p-8 text-center">
